...
# Generated by Powerlevel10k configuration wizard on 2019-10-23 at 13:45 CEST.
# Generated by Powerlevel10k configuration wizard on 2023-10-23 at 11:09 CEST.
...
() {
  ...
  # Remove 1 char gap from right side of prompt
  ...
  # change them.
  typeset -g POWERLEVEL9K_BACKGROUND='#170b3b'                     # purple background
  typeset -g POWERLEVEL9K_LEFT_LEFT_WHITESPACE=' '                 # surrounding whitespace
  typeset -g POWERLEVEL9K_LEFT_RIGHT_WHITESPACE=' '                # surrounding whitespace
  typeset -g POWERLEVEL9K_RIGHT_LEFT_WHITESPACE=''                 # surrounding whitespace
  typeset -g POWERLEVEL9K_RIGHT_RIGHT_WHITESPACE=' '               # surrounding whitespace
  ...
  #
  # CUSTOM: Angle lines between segments
  #
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#170b3b'
  # Make the icon bold.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='%B${P9K_CONTENT// }'
  typeset -g POWERLEVEL9K_OS_ICON_{DEFAULT,SUDO}_CONTENT_EXPANSION='%B${P9K_CONTENT// }'
  typeset -g POWERLEVEL9K_OS_ICON_DEFAULT_CONTENT_EXPANSION='%B${P9K_CONTENT// }'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#dddddd'
  ...
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_FOREGROUND='#ffff00'
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_BACKGROUND='#5f0b0b'
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_SHORTENED_FOREGROUND='#8787af'
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_ANCHOR_FOREGROUND='#ffffff'
  ...
  typeset -g POWERLEVEL9K_VCS_BACKGROUND="#202e32"
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}󱈸${VCS_STATUS_NUM_CONFLICTED}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}+${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}󰦒${VCS_STATUS_NUM_UNSTAGED}"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#170b3b'
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND='#ffcc00'
  typeset -g POWERLEVEL9K_DIRENV_BACKGROUND='#170b3b'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_TASKWARRIOR_BACKGROUND='#36244f'
  ...
  #
  typeset -g POWERLEVEL9K_TASKWARRIOR_CONTENT_EXPANSION='${P9K_TASKWARRIOR_OVERDUE_COUNT:+"%B%196F󱈸%255F$P9K_TASKWARRIOR_OVERDUE_COUNT/"}$P9K_TASKWARRIOR_PENDING_COUNT'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CPU_ARCH_FOREGROUND='#ffffff'
  typeset -g POWERLEVEL9K_CPU_ARCH_BACKGROUND='#36244f'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='#ffff00'
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND='#d75f00'

  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#ffffff'
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND='#4c1f5e'
  ...
  # CUSTOM: Change background based upon hostname
  if [[ $HOST =~ '^p-.+' || $HOST =~ '-prod\.' ]]; then
    typeset -g POWERLEVEL9K_CONTEXT{_REMOTE,_REMOTE_SUDO}_FOREGROUND='#ffff00'
    typeset -g POWERLEVEL9K_CONTEXT{_REMOTE,_REMOTE_SUDO}_BACKGROUND='#af0000'
  elif [[ $HOST =~ '^s-.+' || $HOST =~ '-preprod\.' ]]; then
    typeset -g POWERLEVEL9K_CONTEXT{_REMOTE,_REMOTE_SUDO}_FOREGROUND='#ffff00'
    typeset -g POWERLEVEL9K_CONTEXT{_REMOTE,_REMOTE_SUDO}_BACKGROUND='#af00af'
  elif [[ $HOST =~ '^t-.+' || $HOST =~ '-dev\.' ]]; then
    typeset -g POWERLEVEL9K_CONTEXT{_REMOTE,_REMOTE_SUDO}_FOREGROUND='#000000'
    typeset -g POWERLEVEL9K_CONTEXT{_REMOTE,_REMOTE_SUDO}_BACKGROUND='#ffd700'
  fi
  ...
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND='#ffffff'
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND='#000055'
  # Custom icon.
  typeset -g POWERLEVEL9K_PUBLIC_IP_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_PUBLIC_IP_CONTENT_EXPANSION='${P9K_CONTENT}$(if [[ $P9K_CONTENT == $MY_IP ]]; then echo "%196F 󱈸"; fi)'

  ########################[ vpn_ip: virtual private network indicator ]#########################
  # VPN IP color.
  typeset -g POWERLEVEL9K_VPN_IP_FOREGROUND=40
  typeset -g POWERLEVEL9K_VPN_IP_BACKGROUND=240
  ...
  #########################[ proxy: system-wide http/https/ftp proxy ]##########################
  # Proxy color.
  typeset -g POWERLEVEL9K_PROXY_FOREGROUND='#ffffff'
  typeset -g POWERLEVEL9K_PROXY_BACKGROUND='#000088'
  typeset -g POWERLEVEL9K_PROXY_VISUAL_IDENTIFIER_EXPANSION='󰹷'
  typeset -g POWERLEVEL9K_PROXY_CONTENT_EXPANSION='${P9K_CONTENT/(127.0.0.1|localhost)/}'
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND='#170b3b'
...
function toggle-right-prompt-element {
  p10k display '*/right/*'=hide,show
}
zle -N toggle-right-prompt-element
bindkey '^N' toggle-right-prompt-element


typeset -g POWERLEVEL9K_GO_ICON=''
typeset -g POWERLEVEL9K_PILA_ICON=''
typeset -g POWERLEVEL9K_MISE_FOREGROUND='#ffffff'
typeset -g POWERLEVEL9K_MISE_BACKGROUND='#170b3b'
typeset -g POWERLEVEL9K_MISE_GO_BACKGROUND='#2e7d9b'
typeset -g POWERLEVEL9K_MISE_NODE_BACKGROUND='#5faf00'
typeset -g POWERLEVEL9K_MISE_PERL_BACKGROUND='#4F5D95'
typeset -g POWERLEVEL9K_MISE_PHP_BACKGROUND='#6067af'
typeset -g POWERLEVEL9K_MISE_PYTHON_BACKGROUND='#3572A5'
typeset -g POWERLEVEL9K_MISE_RAKU_BACKGROUND='#0000fb'
typeset -g POWERLEVEL9K_MISE_RUBY_BACKGROUND='#701516'
typeset -g POWERLEVEL9K_MISE_RUST_BACKGROUND='#865434'
typeset -g POWERLEVEL9K_MISE_ENVIRONMENT_FOREGROUND='#202020'
typeset -g POWERLEVEL9K_MISE_ENVIRONMENT_BACKGROUND='#7ee298'
function prompt_mise() {
  # Silently skip when mise or yq isn't available (yet)
  (( $+commands[mise] && $+commands[yq] )) || return
  local plugins_raw=$(
    IGNORE_TOOLS='watchexec|just|hurl|usage|changie|pre-commit|prek'
    mise ls --current --offline --json |
    yq -oc "
      to_entries                                                                  | # Convert to list of objects
      del( .[] | select(.key | match(\"(?:${IGNORE_TOOLS})\"))) | .[]             | # Remove stuff we do not care about
      select(.value.[0].source.path != env(HOME) + \"/.config/mise/config.toml\") | # Remove default tools
      [ [.key, .value.[0].version, .value[0].source.path] ]                         # Return as CSV (list of lists)
    "
  )
  local plugins=("${(@f)$(echo $plugins_raw)}")

  local plugin
  for plugin in ${(k)plugins}; do
    local parts=("${(@s/,/)plugin}")
    local tool=${parts[1]:gs/-/_}
    local version=${parts[2]}
    local toml_path=${parts[3]%\/*mise.toml}
    local pwd=${PWD:A}

    # Handle prefixed tools - just use the last part as tool name
    if [[ "$tool" == "ubi:"* || "$tool" == "github:"* || "$tool" == "cargo:"* ]]; then
      tool="${tool##*/}"
    fi

    if [[ "${toml_path}" = "$pwd[1,${#toml_path}]" ]]; then
      p10k segment -r -i "${tool:u}_ICON" -s "$tool" -t "$version"
    fi
  done
  if [[ -n "${MISE_ENV}" ]]; then
    p10k segment -i '󰋜' -s "ENVIRONMENT" -t "%B$MISE_ENV"
  fi
}
...
typeset -g POWERLEVEL9K_JJ_FOREGROUND='#a7ecf2'
typeset -g POWERLEVEL9K_JJ_BACKGROUND='#252525'
...
function jj_status() {
  ...
  res+=" %B${magenta}${VCS_STATUS_CHANGE[1]}${grey}${VCS_STATUS_CHANGE[2]}"
